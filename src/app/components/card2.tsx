...
function Card2({foto,genre1,judul,desc}:{foto:any, genre1:string, judul:string, desc:string}) {
  return (
   <div className='bg-white mt-5 w-[260px] rounded-b-xl'>
      <img src={foto} alt='foto'/>
      <div className='p-2'>
      <p className={`text-[#260A37] text-[10px] font-bold ${inknut.className}`}>Genre<span className="text-[#AB00E7] ms-3">
              {genre1}</span></p>
      <p className="uppercase text-2xl font-extrabold text-[#AB00E7]">{judul}</p>
      <ul className="flex space-x-3">
              <li className="text-[18px] text-[#DCE013]">
              ★ ★ ★ ★ ★
              </li>
              <li className="text-[12px] my-[5px] text-[#AB00E7]">
               [12323 REVIEW]
              </li>
              <li className="my-[6px]">
      ...
      <p className={`text-[15px] text-[#5B0292] ${imprima.className}`}>{desc}</p>
